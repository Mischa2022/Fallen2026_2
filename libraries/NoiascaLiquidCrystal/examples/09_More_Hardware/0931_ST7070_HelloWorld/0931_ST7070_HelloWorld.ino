...
LiquidCrystal_PCF8574 lcd(addr, cols, rows, convert_ST7070);         // this is for displays with ST7070 driver, it has additional character support

// The extended constructor handles additional characters from Latin-2, Latin-3 and Latin-4
//LiquidCrystal_PCF8574 lcd(addr, cols, rows, convert_ST7070_ext);   // this is for displays with ST7070 driver with extended special character support
