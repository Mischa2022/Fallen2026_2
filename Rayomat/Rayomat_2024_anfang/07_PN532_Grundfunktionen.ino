...
//bestimmung des Trailorblocks
  ...
  if (block==60||block==61||block==62){trailorBlock=63;}
   ...
   //          Serial.println(ergebnisA2);
     ...
     //         Serial.print("ErgebnisB2: ");
     //         Serial.println(ergebnisB2);
     //         Serial.print("Block ");Serial.print(block);Serial.println(" fertig gelesen"); //debug
              return 0;
        }
        else
        {
          Serial.println("Block nicht gelesen"); //debug
          reader=false;
          return 1;
        }
      }
      ...
      {
        Serial.println("Key vielleicht falsch?"); //debug
        reader=false;
        return 1;
      }
success2 =!success2;
 ...
 */
  ...
  Serial.print("Authentizität Block ");
    Serial.print(block);
    Serial.println("nicht ok");
  return 1;
 }
