/*Auflistung Grundsätzlicher RFID Funktionen per MFRC522
 * 
 * reading_MFRC522      //allgemeine Lesefunktion
 * writing_MFRC522           //allgemeine Schreibfunktion
 ...
 * newkey_MFRC522          //Hilfsfunktion zum Bestimmen des aktuellen KeyB nach Checkin
 */


long reading_MFRC522(byte keys[],byte block) {
...
int writing_MFRC522(byte keys[],byte block,unsigned long variableA, unsigned long variableB) {
 ...
 */
  ...
  byte* oldB;
    ...
    MFRC522::MIFARE_Key newkey_MFRC522A2;
    MFRC522::MIFARE_Key newkey_MFRC522B2;
 ...
 for (byte i = 0; i < MFRC522::MF_KEY_SIZE; i++) {
    ...
    newkey_MFRC522A2.keyByte[i] = newA[i];
    newkey_MFRC522B2.keyByte[i] = newB[i];  //KeyB = A default KeyB = B Livesystem
  }
 ...
 //Serial.print("Fertig mit Sector:");
