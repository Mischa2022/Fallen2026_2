...
art= ergebnisB2- medi_id; 
              Serial.print(F("Art:"));Serial.println(art);
switch (art) {
     case 177:
     Serial.println(F("Dekon gefunden")); 
     sorte=3;
     ziel_char='b';
     ziel_long=sorte;
     break;   
     ...
     case 255:// original
     Serial.println(F("NanoClean gefunden"));
     sorte=2;
     ziel_char='b';
     ziel_long=sorte;
     break;
     ...
     case 367:
     Serial.println(F("Blutwäsche gefunden")); 
     sorte=5;
     ziel_char='b';
     ziel_long=sorte;
     break;   
     ...
     case 583:
     Serial.println(F("Cleanray gefunden")); 
     sorte=6;
     ziel_char='b';
     ziel_long=sorte;
     break;
     ...
     case 722:
     Serial.println(F("LifeCleaner gefunden")); 
     sorte=4;
     ziel_char='b';
     ziel_long=sorte;
     break;
     ...
     default:
     Serial.println(F("nichts gefunden")); 
     sorte=0;
     break;
     }
