...
//char* grund[] {"nein","zu früh","zu spät"};
unsigned long Bonus;
unsigned long delta;
...
///////////////////////////////////////////////////////////////////////////////////////
                  ...
                  if(LifeCleaner_effekt_read>=aktuell_time){
                      ...
                      time_writing=aktuell_time; //damit läuft bei jedem versuch auch last_booking hoch, halte ich für sinnvoll
                      if(medikament==7){
                        Bonus=0;
                      }
                  }else {
                      ...
                      /*
                      if(aktuell_time-Last_Booking_read<0){ //macht diese abfrage sinn?
                        //10-9<0
                        //10>9
                        delta=0;
                      }
