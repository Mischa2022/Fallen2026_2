                 ...
                 read_Char3 = (char)Serial.read();
                  ...
                  neu_konfig += read_Char3;
                     ...
                     if (SD.exists("konfig.txt")) {
                      ...
                      delay(100);
                      Serial.println(F("alte Konfig gelöscht"));
                      }
...
// Uhr stellen serial
    ...
    t = rtc.now(); 
      ...
      case 'k':      buzzer_play( 1,100);
                   ...
                   Serial.println(F("Deko|Nano|Life|Clea|Bloo|Draw|"));
                   Serial.println(read_String2);
                        }
                       else {
                
                  Serial.println(F("medi.txt nicht vorhanden"));
                      }
...
//Medilogs löschen
      case '=':    buzzer_play( 1,100);
                   ...
                   Serial.println(F("medilogs gelöscht"));
                   SD.remove("medi.txt");
                   ziel_long=0;
                   ziel_char=' ';  
