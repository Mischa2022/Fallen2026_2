...
/*
   ...
   Serial.print("Con_Start_read:");Serial.print(Con_Start_read);Serial.print(" : ");Serial.print("con_start_time:");Serial.println(con_start_time);
...
if(Con_End_read==0){
 ...
 /////////////////////////////////////////////// 
   ...
   else{   checkin_reason=0; }//gibt es bei Check_rfid_tag einen Fehler, unterbrech hier und geh zum ende
