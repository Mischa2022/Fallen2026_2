...
//Tag_analyse steps 2 *********************************************************************//       
    if(key==0){ 
      ...
      if(key==32){ 
        ...
        Serial.print(F("Key 2. soll 32:"));Serial.println(key);
        key_state=1;
        error=1;
      }
      }
  ...
  msg4="Ray:";
        ...
        if(LifeCleaner_effekt_read>=aktuell_time){
             ...
             // deltaray2=(tagesdosis*delta2/86400)*1000;
              deltaray2=(tagesdosis*delta2*10)/864;
...
//Tag_analyse steps 4 *********************************************************************//
  if(error!=0||key_state==1){ // wenn Check_rfid_tag einen Fehler ausweist direkt weiter zum Ende
