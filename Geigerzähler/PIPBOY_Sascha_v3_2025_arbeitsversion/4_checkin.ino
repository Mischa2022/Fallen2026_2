/*Auflistung Unterfunktionen, die für Checkin einens Dongels benötigt werden
 * 
 * checkin     //Helferfunktion um einen Spieler_Dongel ein zu checken
 */
...
//Ausgabe Terminal was gestartet wird********************************************************
    ...
    if(sorte==360){       
      ...
      myprint(typ[auswahl],"","",true,true,false,1,0);        
  ...
  if(key==0){ 
    ...
    if(key==32){ 
      ...
      error=1;
          ...
          Display.print(5);Display.print("/100");
          Display.display();
          delay(100);
...
//prozess();
 ...
 myprint("Bisherige Werte","","",true,true,false,1,0);  
      Check_rfid_tag(1,0);

          Display.clearDisplay();
          Display.setCursor( 0, 30);
          Display.print(10);Display.print("/100");
          Display.display();
          delay(100);      
      ...
      if(Con_Start_read!=0&&Ray_value_extern_read!=0){ 
        ...
        if(Con_Start_read!=con_start_time&&Con_Start_read!=0&&Ray_value_extern_read!=0){
          ...
          if(Last_Booking_read<LifeCleaner_effekt_read){
            ...
            myprint("Hat Lifecleaner genommen!","","",true,true,false,1,0);
          ...
          Display.clearDisplay();
          Display.setCursor( 0, 30);
          Display.print(20);Display.print("/100");
          Display.display();
          delay(100);
...
if(Con_End_read==0){
          ...
          Serial.println("Hochgerechnet");
          delay(50);
      }
       else{    delta=(Con_End_read-Last_Booking_read);
                Serial.println("Berechnet durch Con_End");
                delay(50);
       }     
 ...
 /////////////////////////////////////////////// 
          ...
          Display.clearDisplay();
          Display.setCursor( 0, 30);
          Display.print(30);Display.print("/100");
          Display.display();
          delay(100);
          myprint("statischer Raywert:","",Ray_value_extern_read,true,true,false,1,0);
          myprint("Aufschlag Ray:","",delta2,true,true,false,1,0);
          myprint("--------------------------------------------","","",true,true,false,1,0);
...
//Setzen neuer Keys ***********************************************************************
          Display.clearDisplay();
          Display.setCursor( 0, 30);
          Display.print(40);Display.print("/100");
          Display.display();
          delay(100);
  if(error==0){ 
      if(steps==0){
...
// das verursacht bei abbruch einen leeren Dongel von den Werten her.                              
      if(steps==1&&error==0&&key_state==0){  
        ...
        for(int r=0;r<=46;r++){
          ...
          delay(10); 
             Display.setCursor( 0, 30);
          Display.print(r+40);Display.print("/100");
          Display.display();
          delay(100);
        }
      } 
...
//prozess();
          Display.clearDisplay();
          Display.setCursor( 0, 30);
          Display.print(90);Display.print("/100");
          Display.display();
          delay(100);
    ...
    //    msg3="";
     ...
     Serial.println("Umschreiben Dongel");
      //Con_Daten
    ...
    Bereich=0;
              ...
              Display.clearDisplay();
          Display.setCursor( 0, 30);
          Display.print(100);Display.print("/100");
          Display.display();
          delay(100);
}
