...
APP_TITLE = "GODZILLA 3.0 Professional"
BAUDRATE = 57600
FULLSCREEN = False
COLUMNS = 4
...
class GodzillaApp:
    ...
    # ------------------------------------------------------
    # 🔥 ZENTRALE SENDE-FUNKTION MIT MONITOR-CLEAR
    # ------------------------------------------------------
    ...
    def update_buttons(self):
        ...
        for i, label in enumerate(config["labels"]):
            ...
            ttk.Button(
                self.button_frame,
                text=label,
                command=lambda cmd=config["commands"][i]:
